 ...
 */
export default function FloatingNotificationInbox({ launcherRef, isOpen, toggle, placement, width, onNotificationClick, closeOnClickOutside, closeOnNotificationClick, popperOptions, hideArrow, layout, ...inboxProps }: Props): JSX.Element;
