...
export declare type NotificationCompareStrategy = (notification: IRemoteNotification, context: Record<string, any>, comparator?: IStrategyComparator) => {
    result: boolean;
    delta: string[];
};
/**
 ...
 */
export declare function objMatchesContext(notification: IRemoteNotification, context: Record<string, any>, comparator?: IStrategyComparator): {
    result: boolean;
    delta: string[];
};
